...
from api.sql import Member, Order_List, Product, Record, Cart, Surgery
...
def bookstore():
    ...
    if 'keyword' in request.args and 'page' in request.args:
        ...
        dataDoc = Product.get_doctor(eId)

        doctorName = dataDoc[1]
        ...
        rr = dataVitalSign[1]
        bp = dataVitalSign[2]
        spo2 = dataVitalSign[3]
        bt = dataVitalSign[4]
        score = dataVitalSign[5]
        risk = dataVitalSign[6]
        pulse = dataVitalSign[8]

        dataBed = Product.get_bedId(pid)
